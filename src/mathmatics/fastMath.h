...
#define INT_TO_FIXED(x) ((fast_int)((x) << DECIMAL_PRECISION))
#define FIXED_TO_INT(x) ((int)((x) >> DECIMAL_PRECISION))
#define FLOAT_TO_FIXED(x) ((fast_int)((x) * (1 << DECIMAL_PRECISION)))
#define FIXED_TO_FLOAT(x) ((float)(x) / (1 << DECIMAL_PRECISION))
...
#define FIXED_MUL(x, y) ((fast_int)(((int32_t)(x) * (int32_t)(y)) >> DECIMAL_PRECISION))
#define FIXED_DIV(x, y) ((fast_int)((((int32_t)(x) << DECIMAL_PRECISION) / (int32_t)(y))))
